...
Page({
  build() {
    ...
    hmUI.createWidget(hmUI.widget.BUTTON, {
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/416x416/game/index.page'})}
    })
    hmUI.createWidget(hmUI.widget.BUTTON, {
      x: px(110),
      y: px(220),
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/416x416/set/index.page'})}
    })
    hmUI.createWidget(hmUI.widget.BUTTON, {
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/416x416/ranking/index.page'})}
    })
  },
  onInit() {
