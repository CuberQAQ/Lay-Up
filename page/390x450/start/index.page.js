...
Page({
  build() {
    ...
    hmUI.createWidget(hmUI.widget.BUTTON, {
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/390x450/game/index.page'})}
    })
    hmUI.createWidget(hmUI.widget.BUTTON, {
      x: px(110),
      y: px(270),
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/390x450/set/index.page'})}
    })
    hmUI.createWidget(hmUI.widget.BUTTON, {
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/390x450/ranking/index.page'})}
    })
  },
  onInit() {
