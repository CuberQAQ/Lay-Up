...
const TOTAL_LAYER_WIDGET_NUMBER = 5
...
Page({
  build() {
    ...
    var nowY = -150 // not including floor height ; the bottom of the screen
    ...
    function gameOver() {
      ...
      fxOverScore = new Fx({
        ...
        // 每一帧的回调函数，参数为当前函数值，取值范围为[begin, end]
        func: result => {
          let border = Fx.getMixBorder(scoreWidgetBorder, overScoreTitleBorder, result)
