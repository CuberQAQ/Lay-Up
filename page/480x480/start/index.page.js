...
Page({
  build() {
    ...
    hmUI.createWidget(hmUI.widget.BUTTON, {
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/480x480/game/index.page'})}
    })
    hmUI.createWidget(hmUI.widget.BUTTON, {
      x: px(110),
      y: px(220),
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/480x480/set/index.page'})}
    })
    hmUI.createWidget(hmUI.widget.BUTTON, {
      ...
      click_func: () => {hmApp.gotoPage({file: 'page/480x480/ranking/index.page'})}
    })
  },
  onInit() {
